...
call :functions_yesOrNot "Would you like to execute test script? " 2-test-package.bat
call :functions_yesOrNot "Would you like to push to repository? " 3-push-package.bat
